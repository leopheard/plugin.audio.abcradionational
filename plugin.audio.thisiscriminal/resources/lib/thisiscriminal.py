...
def compile_new_to_criminal(compile_ntc):
    ...
    items = [{
		    'label': 'Episode 85: The Manual',
        	    'thumbnail': 'https://thisiscriminal.com/wp-content/uploads/2018/02/CRIM_HIT-01-600x600.png',
		    ...
		    {'label': 'Episode 1: Animal Instincts',
        	    'thumbnail': 'https://thisiscriminal.com/wp-content/uploads/2014/01/Criminal_Graphics-01_Owl-300x300-1.png',
